...
// TODO: del
public class DefaultOneReadFileReaderOld implements ReaderOld {
    public enum Code {
        CANNOT_READ
    }
    ...
    public DefaultOneReadFileReaderOld(final String path) {
        this(Path.of(path));
    }

    public DefaultOneReadFileReaderOld(final Path path) {
        this.path = path;
    }
