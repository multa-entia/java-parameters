...
class DefaultFileReaderTest {
    ...
    void shouldCheckBuilding_ifPathNull() {
        Result<Reader> result = DefaultFileReader.builder().build();
    ...
    void shouldCheckBuilding_ifIdNotSet() {
        ...
        Result<Reader> result = DefaultFileReader.builder().path(expectedPath).build();
    ...
    void shouldCheckBuilding() {
        Path expectedPath = DUMMY_PATH;
        Id expectedId = Mockito.mock(Id.class);
        Result<Reader> result = DefaultFileReader.builder()
                .path(expectedPath)
                .id(expectedId)
                .build();
    ...
    void shouldCheckReading_ifFail() {
        Reader reader = DefaultFileReader.builder().path(Path.of(calculatePath(NON_EXIST_PATH_NAME))).build().value();
    ...
    void shouldCheckReading() {
        ...
        Reader reader = DefaultFileReader.builder().path(path).build().value();
        ...
        assertThat(result.value().get(DefaultFileReader.Properties.CONTENT.name())).isEqualTo(expectedContent);
    }
